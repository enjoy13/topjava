...
public class MealTestData {
    ...
    public static final Meal ADMIN_MEAL_WITH_USER = new Meal(ADMIN_MEAL_ID, of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510, ADMIN);

    public static final List<Meal> MEALS = List.of(MEAL7, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
    public static final List<Meal> ADMIN_MEALS = List.of(ADMIN_MEAL_WITH_USER, ADMIN_MEAL2);
