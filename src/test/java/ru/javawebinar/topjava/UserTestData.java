...
public class UserTestData {
    ...
    public static final User ADMIN = new User(ADMIN_ID, "Admin", "admin@gmail.com", "admin", Set.of(ROLE_USER, ROLE_ADMIN));

    public static User getNew() {
        return new User(null, "New", "new@gmail.com", "newPass", 1555, false, new Date(), Collections.singleton(ROLE_USER));
    }

    public static User getNewWhithTwoRoles() {
        return new User(ADMIN_ID, "New", "new@gmail.com", "newPass", 1555, false, new Date(), Set.of(ROLE_USER, ROLE_ADMIN));
    }
